...
const compPerformance = performance.now() - 1000 * -1
let numberOfStars = compPerformance * 2
let numberofCircles = 10
let circleSize = 2000

console.log("compPerformance", compPerformance)
console.log("Number of Stars", numberofCircles)
